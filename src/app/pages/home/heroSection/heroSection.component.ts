...
import { RoundedButtonComponent } from "../../../shared/components/button/button/rounded-button.component";
...
@Component({
  ...
  standalone: true,
  imports: [IonCol, IonRow, IonGrid, NgClass, RoundedButtonComponent,RouterModule],
